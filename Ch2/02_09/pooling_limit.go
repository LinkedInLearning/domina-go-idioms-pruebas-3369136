...
// pokemonIncursionLimit: simulamos una incursión de pokemons, en la que unos cuantos entrenadores intentan capturar pokemons.
...
func pokemonIncursionLimit() {
	...
	// el channel es buffered, con el número de entrenadores como tamaño
	...
	fmt.Println("gimnasio: termina la incursión de pokemons con límite de capturas")
